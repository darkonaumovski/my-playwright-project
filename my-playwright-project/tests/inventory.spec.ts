...
test.describe("Inventory", () => {
  ...
  test("opens a matching product detail page and returns to products", async ({
    page,
    inventory,
    productDetails,
  }) => {
  ...
  test("adds and removes a product from inventory", async ({
    inventory,
    header,
  }) => {
  ...
  test("adds a product from its detail page", async ({
    inventory,
    productDetails,
    header,
  }) => {
