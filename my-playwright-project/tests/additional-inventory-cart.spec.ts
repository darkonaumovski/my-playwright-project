...
test.describe('Additional inventory and cart coverage', () => {
  test('keeps product identity paired through every sort order', async ({ inventory }) => {
  ...
  test('opens the matching detail page from image and title for every product', async ({ page, inventory, productDetails }) => {
  ...
  test('prevents duplicate cart entries after repeated add attempts', async ({ page, inventory, cart, header }) => {
  ...
  test('maintains cart row accuracy while removing middle and final items', async ({ page, inventory, cart, header }) => {
  ...
  test('refreshes stale product actions after Reset App State', async ({ page, inventory, header }) => {
    await inventory.addProduct('sauce-labs-backpack');
  ...
  test('opens a cart item detail page with the correct Remove state', async ({ page, inventory, cart, productDetails, header }) => {
    await inventory.addProduct('sauce-labs-backpack');
    await cart.goto();
